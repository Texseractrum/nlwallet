...
"[project]/node_modules/@moralisweb3/common-evm-utils/lib/esm/index.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_esm__({
    ...
    "CommonEvmUtilsConfigSetup": (()=>CommonEvmUtilsConfigSetup),
    ...
    "EvmBlock": (()=>EvmBlock),
    "EvmBlockDate": (()=>EvmBlockDate),
    "EvmBlockTokenStat": (()=>EvmBlockTokenStat),
    "EvmBlockTokenStatNftTransfers": (()=>EvmBlockTokenStatNftTransfers),
    "EvmBlockTokenStatTransactions": (()=>EvmBlockTokenStatTransactions),
    "EvmChain": (()=>EvmChain),
    "EvmChainList": (()=>EvmChainList),
    "EvmChainNetWorth": (()=>EvmChainNetWorth),
    "EvmChainParser": (()=>EvmChainParser),
    "EvmChainResolver": (()=>EvmChainResolver),
    "EvmCommonContractData": (()=>EvmCommonContractData),
    "EvmContractSpenderDetails": (()=>EvmContractSpenderDetails),
    "EvmContractTokenDetails": (()=>EvmContractTokenDetails),
    "EvmContractsReviewDto": (()=>EvmContractsReviewDto),
    "EvmContractsReviewItem": (()=>EvmContractsReviewItem),
    "EvmContractsReviewItemContractTypeEnum": (()=>EvmContractsReviewItemContractTypeEnum),
    "EvmContractsReviewItemReportTypeEnum": (()=>EvmContractsReviewItemReportTypeEnum),
    "EvmDecodedEvent": (()=>EvmDecodedEvent),
    "EvmDecodedEventParamsItem": (()=>EvmDecodedEventParamsItem),
    "EvmDefiPositionDetails": (()=>EvmDefiPositionDetails),
    "EvmDefiPositionDetailsNftMetadata": (()=>EvmDefiPositionDetailsNftMetadata),
    "EvmDefiPositionSummaryResponse": (()=>EvmDefiPositionSummaryResponse),
    "EvmDefiProtocolBalance": (()=>EvmDefiProtocolBalance),
    "EvmDefiProtocolList": (()=>EvmDefiProtocolList),
    "EvmDefiProtocolPosition": (()=>EvmDefiProtocolPosition),
    "EvmDefiTokenBalance": (()=>EvmDefiTokenBalance),
    "EvmDiscoveryApiChainsList": (()=>EvmDiscoveryApiChainsList),
    "EvmETransactionCategory": (()=>EvmETransactionCategory),
    "EvmEndpointWeights": (()=>EvmEndpointWeights),
    "EvmErc20Metadata": (()=>EvmErc20Metadata),
    "EvmErc20MetadataLinks": (()=>EvmErc20MetadataLinks),
    "EvmErc20Price": (()=>EvmErc20Price),
    "EvmErc20TokenBalanceWithPrice": (()=>EvmErc20TokenBalanceWithPrice),
    "EvmErc20TokenBalanceWithPriceResult": (()=>EvmErc20TokenBalanceWithPriceResult),
    "EvmErc20TokenOwner": (()=>EvmErc20TokenOwner),
    "EvmErc20TokenOwnerCollection": (()=>EvmErc20TokenOwnerCollection),
    "EvmErc20TokenStat": (()=>EvmErc20TokenStat),
    "EvmErc20TokenStatTransfers": (()=>EvmErc20TokenStatTransfers),
    "EvmEvent": (()=>EvmEvent),
    "EvmGetDefiPositionsByProtocol": (()=>EvmGetDefiPositionsByProtocol),
    "EvmGetMultipleTokenPricesDto": (()=>EvmGetMultipleTokenPricesDto),
    "EvmGetMultipleTokenPricesIncludeEnum": (()=>EvmGetMultipleTokenPricesIncludeEnum),
    "EvmGetNFTTradesMarketplaceEnum": (()=>EvmGetNFTTradesMarketplaceEnum),
    "EvmGetPairPrice": (()=>EvmGetPairPrice),
    "EvmGetWalletProfitabilitySummary": (()=>EvmGetWalletProfitabilitySummary),
    "EvmInternalTransaction": (()=>EvmInternalTransaction),
    "EvmLogVerbose": (()=>EvmLogVerbose),
    "EvmMarketDataERC20TokenItem": (()=>EvmMarketDataERC20TokenItem),
    "EvmMarketDataERC20TokensByPriceMovers": (()=>EvmMarketDataERC20TokensByPriceMovers),
    "EvmMarketDataHottestNFTCollectionByTradingVolumeItem": (()=>EvmMarketDataHottestNFTCollectionByTradingVolumeItem),
    "EvmMarketDataTopCryptoCurrenciesByMarketCapItem": (()=>EvmMarketDataTopCryptoCurrenciesByMarketCapItem),
    "EvmMarketDataTopNFTCollectionByMarketCapItem": (()=>EvmMarketDataTopNFTCollectionByMarketCapItem),
    "EvmNative": (()=>EvmNative),
    "EvmNativeErc20Price": (()=>EvmNativeErc20Price),
    "EvmNativeTransfer": (()=>EvmNativeTransfer),
    "EvmNetWorthResult": (()=>EvmNetWorthResult),
    "EvmNft": (()=>EvmNft),
    "EvmNftCollection": (()=>EvmNftCollection),
    "EvmNftCollectionStat": (()=>EvmNftCollectionStat),
    "EvmNftCollectionStatOwners": (()=>EvmNftCollectionStatOwners),
    "EvmNftCollectionStatTransfers": (()=>EvmNftCollectionStatTransfers),
    "EvmNftMedia": (()=>EvmNftMedia),
    "EvmNftMetadata": (()=>EvmNftMetadata),
    "EvmNftTokenStat": (()=>EvmNftTokenStat),
    "EvmNftTokenStatOwners": (()=>EvmNftTokenStatOwners),
    "EvmNftTokenStatTransfers": (()=>EvmNftTokenStatTransfers),
    "EvmNftTradesChainList": (()=>EvmNftTradesChainList),
    "EvmNftTransfer": (()=>EvmNftTransfer),
    "EvmNormalizedMetadata": (()=>EvmNormalizedMetadata),
    "EvmNormalizedMetadataAttribute": (()=>EvmNormalizedMetadataAttribute),
    "EvmNormalizedMetadataAttributeValue": (()=>EvmNormalizedMetadataAttributeValue),
    "EvmOrderList": (()=>EvmOrderList),
    "EvmResolveAddressToDomainCurrencyEnum": (()=>EvmResolveAddressToDomainCurrencyEnum),
    "EvmResolveContractInteractionResponse": (()=>EvmResolveContractInteractionResponse),
    "EvmReviewContracts": (()=>EvmReviewContracts),
    "EvmSignature": (()=>EvmSignature),
    "EvmSimpleBlock": (()=>EvmSimpleBlock),
    "EvmSoldPrice": (()=>EvmSoldPrice),
    "EvmSoldPriceAverageSale": (()=>EvmSoldPriceAverageSale),
    "EvmSoldPriceHighestSale": (()=>EvmSoldPriceHighestSale),
    "EvmSoldPriceHighestSalePaymentToken": (()=>EvmSoldPriceHighestSalePaymentToken),
    "EvmSoldPriceLastSale": (()=>EvmSoldPriceLastSale),
    "EvmSoldPriceLastSalePaymentToken": (()=>EvmSoldPriceLastSalePaymentToken),
    "EvmSoldPriceLowestSale": (()=>EvmSoldPriceLowestSale),
    "EvmSoldPriceLowestSalePaymentToken": (()=>EvmSoldPriceLowestSalePaymentToken),
    "EvmTokenPriceItem": (()=>EvmTokenPriceItem),
    "EvmTopProfitableWalletPerTokenResponse": (()=>EvmTopProfitableWalletPerTokenResponse),
    "EvmTrade": (()=>EvmTrade),
    "EvmTradeCollection": (()=>EvmTradeCollection),
    "EvmTransaction": (()=>EvmTransaction),
    "EvmTransactionLog": (()=>EvmTransactionLog),
    "EvmTransactionLogDecoded": (()=>EvmTransactionLogDecoded),
    "EvmTransactionTimestamp": (()=>EvmTransactionTimestamp),
    "EvmTransactionVerbose": (()=>EvmTransactionVerbose),
    "EvmUnavailableChainNetWorth": (()=>EvmUnavailableChainNetWorth),
    "EvmUnstoppableDomain": (()=>EvmUnstoppableDomain),
    "EvmWalletActiveChain": (()=>EvmWalletActiveChain),
    "EvmWalletActiveChains": (()=>EvmWalletActiveChains),
    "EvmWalletDefiSummary": (()=>EvmWalletDefiSummary),
    "EvmWalletHistory": (()=>EvmWalletHistory),
    "EvmWalletHistoryErc20Transfer": (()=>EvmWalletHistoryErc20Transfer),
    "EvmWalletHistoryNftTransfer": (()=>EvmWalletHistoryNftTransfer),
    "EvmWalletHistoryTransaction": (()=>EvmWalletHistoryTransaction),
    "EvmWalletProfitabilityResponse": (()=>EvmWalletProfitabilityResponse),
    "EvmWalletProfitabilityTokenData": (()=>EvmWalletProfitabilityTokenData),
    "EvmWalletStat": (()=>EvmWalletStat),
    "EvmWalletStatNftTransfers": (()=>EvmWalletStatNftTransfers),
    "EvmWalletStatTokenTransfers": (()=>EvmWalletStatTokenTransfers),
    "EvmWalletStatTransactions": (()=>EvmWalletStatTransactions),
    "EvmWalletTopProfitableWalletPerTokenResponse": (()=>EvmWalletTopProfitableWalletPerTokenResponse),
    "EvmWeb3version": (()=>EvmWeb3version),
    "GetBlockStatsOperation": (()=>GetBlockStatsOperation),
    "GetDefiPositionsByProtocolOperation": (()=>GetDefiPositionsByProtocolOperation),
    "GetDefiPositionsSummaryOperation": (()=>GetDefiPositionsSummaryOperation),
    "GetDefiSummaryOperation": (()=>GetDefiSummaryOperation),
    "GetHottestNFTCollectionsByTradingVolumeOperation": (()=>GetHottestNFTCollectionsByTradingVolumeOperation),
    "GetMultipleTokenPricesOperation": (()=>GetMultipleTokenPricesOperation),
    "GetNFTCollectionStatsOperation": (()=>GetNFTCollectionStatsOperation),
    "GetNFTContractSalePricesOperation": (()=>GetNFTContractSalePricesOperation),
    "GetNFTSalePricesOperation": (()=>GetNFTSalePricesOperation),
    "GetNFTTokenStatsOperation": (()=>GetNFTTokenStatsOperation),
    "GetNFTTradesByTokenOperation": (()=>GetNFTTradesByTokenOperation),
    "GetNFTTradesOperation": (()=>GetNFTTradesOperation),
    "GetPairPriceOperation": (()=>GetPairPriceOperation),
    "GetTokenOwnersOperation": (()=>GetTokenOwnersOperation),
    "GetTokenStatsOperation": (()=>GetTokenStatsOperation),
    "GetTopCryptoCurrenciesByMarketCapOperation": (()=>GetTopCryptoCurrenciesByMarketCapOperation),
    "GetTopCryptoCurrenciesByTradingVolumeOperation": (()=>GetTopCryptoCurrenciesByTradingVolumeOperation),
    "GetTopERC20TokensByMarketCapOperation": (()=>GetTopERC20TokensByMarketCapOperation),
    "GetTopERC20TokensByPriceMoversOperation": (()=>GetTopERC20TokensByPriceMoversOperation),
    "GetTopNFTCollectionsByMarketCapOperation": (()=>GetTopNFTCollectionsByMarketCapOperation),
    "GetTopProfitableWalletPerTokenOperation": (()=>GetTopProfitableWalletPerTokenOperation),
    "GetWalletActiveChainsOperation": (()=>GetWalletActiveChainsOperation),
    "GetWalletHistoryOperation": (()=>GetWalletHistoryOperation),
    "GetWalletNetWorthOperation": (()=>GetWalletNetWorthOperation),
    "GetWalletProfitabilityOperation": (()=>GetWalletProfitabilityOperation),
    "GetWalletProfitabilitySummaryOperation": (()=>GetWalletProfitabilitySummaryOperation),
    "GetWalletStatsOperation": (()=>GetWalletStatsOperation),
    "GetWalletTokenBalancesPriceOperation": (()=>GetWalletTokenBalancesPriceOperation),
    "ResolveAddressToDomainOperation": (()=>ResolveAddressToDomainOperation),
    "ReviewContractsOperation": (()=>ReviewContractsOperation),
    ...
    "getInternalTransactionsOperation": (()=>getInternalTransactionsOperation),
    ...
    "getTransactionVerboseOperation": (()=>getTransactionVerboseOperation),
    ...
    "resolveENSDomainOperation": (()=>resolveENSDomainOperation),
...
var EvmNftTradesChainList = function() {
...
var EvmGetNFTTradesMarketplaceEnum = function() {
...
var EvmGetMultipleTokenPricesIncludeEnum = function() {
...
var EvmResolveAddressToDomainCurrencyEnum = function() {
...
var EvmDefiProtocolList = function() {
...
var EvmDiscoveryApiChainsList = function() {
...
var EvmETransactionCategory = function() {
...
var EvmErc20MetadataLinks = function() {
...
var EvmContractsReviewItemReportTypeEnum = function() {
...
var EvmContractsReviewItemContractTypeEnum = function() {
...
var EvmDefiPositionDetailsNftMetadata = function() {
...
var EvmNormalizedMetadataAttributeValue = function() {
 ...
 */ var EvmAddress = function() {
    ...
    EvmAddress.parse = function(address) {
        if (!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ethersproject$2f$address$2f$lib$2e$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isAddress"])(address)) {
 ...
 */ var Erc20Token = function() {
    ...
    Erc20Token.parse = function(value) {
        return {
            decimals: +value.decimals,
            name: value.name,
            symbol: value.symbol,
            contractAddress: EvmAddress.create(value.contractAddress),
            logo: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(value.logo),
            logoHash: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(value.logoHash),
            thumbnail: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(value.thumbnail),
 ...
 */ var Erc20Approval = function() {
    ...
    Erc20Approval.parse = function(data) {
        return __assign(__assign({}, data), {
            ...
            blockTimestamp: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dateInputToDate"])(data.blockTimestamp),
            blockNumber: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.blockNumber),
            value: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.value),
 ...
 */ var Erc20Transaction = function() {
    ...
    Erc20Transaction.parse = function(data) {
        return __assign(__assign({}, data), {
            chain: EvmChain.create(data.chain),
 ...
 */ var Erc20Value = function() {
    ...
    Erc20Value.parse = function(_a) {
        ...
        if (token && token.decimals && +token.decimals !== +decimals) {
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CoreError"]({
                code: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CoreErrorCode"].INVALID_DATA,
                message: 'Decimals do not match'
            });
        }
        return {
            amount: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(amount),
            decimals: +decimals
        };
    };
    return Erc20Value;
 ...
 */ var EvmNative = function() {
    ...
    EvmNative.parse = function(native, unit) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].fromDecimal(native.toString(), decimals);
    };
    /**
 ...
 *
 * @category DataType
 */ var EvmTransactionLog = function() {
    ...
    EvmTransactionLog.parse = function(value) {
        return {
            chain: EvmChain.create(value.chain),
            logIndex: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(value.logIndex, function(index) {
                return +index;
            }),
            transactionHash: value.transactionHash,
            transactionIndex: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(value.transactionIndex),
            data: value.data,
            topics: value.topics,
 ...
 */ var EvmSignature = function() {
    ...
    Object.defineProperty(EvmSignature.prototype, "serialized", {
        get: function() {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ethersproject$2f$bytes$2f$lib$2e$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["joinSignature"])(this._data);
        },
        enumerable: false,
        configurable: true
    });
    ...
    EvmSignature.parse = function(data) {
        if (typeof data === 'string') {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ethersproject$2f$bytes$2f$lib$2e$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["splitSignature"])(data);
        }
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ethersproject$2f$bytes$2f$lib$2e$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["splitSignature"])({
            r: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ethersproject$2f$bytes$2f$lib$2e$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hexlify"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.r).toBigInt()),
            s: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ethersproject$2f$bytes$2f$lib$2e$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["hexlify"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.s).toBigInt()),
            v: +data.v
        });
    };
    return EvmSignature;
 ...
 *
 * @category DataType
 */ var EvmInternalTransaction = function() {
    ...
    EvmInternalTransaction.parse = function(data) {
        return {
            from: EvmAddress.create(data.from),
            to: EvmAddress.create(data.to),
            transactionHash: data.transactionHash,
            gas: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.gas),
            gasUsed: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.gasUsed),
            blockNumber: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.blockNumber),
 ...
 */ var EvmTransaction = function() {
    ...
    EvmTransaction.parse = function(data) {
        ...
        return {
            from: EvmAddress.create(data.from),
            to: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.to, function(to) {
                return EvmAddress.create(to);
            }),
            nonce: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.nonce, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create),
            data: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.data),
            value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.value, function(val) {
                return EvmNative.create(val, 'wei');
            }),
            hash: data.hash,
            chain: EvmChain.create(data.chain),
            gas: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.gas, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create),
            gasPrice: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.gasPrice),
            index: +data.index,
            blockNumber: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.blockNumber),
            blockHash: data.blockHash,
            blockTimestamp: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dateInputToDate"])(data.blockTimestamp),
            cumulativeGasUsed: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.cumulativeGasUsed),
            gasUsed: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.gasUsed),
            contractAddress: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.contractAddress, function(address) {
                return EvmAddress.create(address);
            }),
            receiptRoot: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.receiptRoot),
            receiptStatus: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.receiptStatus, function(status) {
                return +status;
            }),
            ...
            signature: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.signature, EvmSignature.create)
        };
    };
    /**
    ...
    EvmTransaction.prototype.toJSON = function() {
        ...
        var data = this._data;
        return __assign(__assign({}, data), {
            to: (_a = data.to) === null || _a === void 0 ? void 0 : _a.toJSON(),
            from: (_b = data.from) === null || _b === void 0 ? void 0 : _b.toJSON(),
            ...
            chain: (_j = data.chain) === null || _j === void 0 ? void 0 : _j.toJSON(),
            contractAddress: (_k = data.contractAddress) === null || _k === void 0 ? void 0 : _k.toJSON(),
 ...
 */ var EvmSimpleBlock = function() {
    ...
    EvmSimpleBlock.parse = function(data) {
        return {
            timestamp: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dateInputToDate"])(data.timestamp),
            number: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.number),
            chain: EvmChain.create(data.chain),
            hash: data.hash
        };
    };
 ...
 */ var EvmBlock = function() {
    ...
    EvmBlock.parse = function(data) {
        return __assign(__assign({}, data), {
            miner: EvmAddress.create(data.miner),
            timestamp: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dateInputToDate"])(data.timestamp),
            number: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.number),
            difficulty: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.difficulty),
            totalDifficulty: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.totalDifficulty),
            size: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.size),
            gasLimit: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.gasLimit),
            gasUsed: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.gasUsed),
            transactions: data.transactions.map(function(transaction) {
 ...
 */ var EvmEvent = function() {
    ...
    EvmEvent.parse = function(data) {
        return __assign(__assign({}, data), {
            ...
            blockTimestamp: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dateInputToDate"])(data.blockTimestamp),
            data: {
                from: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.data.from, function(from) {
                    return EvmAddress.create(from);
                }),
                to: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.data.to, function(to) {
                    return EvmAddress.create(to);
                }),
                value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.data.value, EvmNative.create)
            }
        });
    };
    return EvmEvent;
 ...
 */ var EvmNftMedia = function() {
    ...
    EvmNftMedia.parse = function(data) {
        return __assign(__assign({}, data), {
            chain: EvmChain.create(data.chain),
            updatedAt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.updatedAt, function(date) {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dateInputToDate"])(date);
            })
        });
    };
    return EvmNftMedia;
 ...
 */ var EvmNft = function() {
     ...
     */ EvmNft.prototype.toJSON = function() {
        ...
        return __assign(__assign({}, data), {
            ...
            chain: data.chain.toJSON(),
            ownerOf: (_b = data.ownerOf) === null || _b === void 0 ? void 0 : _b.toJSON(),
            ...
            media: (_e = data.media) === null || _e === void 0 ? void 0 : _e.format()
        });
    };
    /**
     * @deprecated This method will be removed soon. To format the value, use one of the properties.
    ...
    var _a;
    _a = EvmNft;
    EvmNft.parse = function(data) {
        return __assign(__assign({}, data), {
            chain: EvmChain.create(data.chain),
            contractType: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.contractType),
            tokenAddress: EvmAddress.create(data.tokenAddress),
            metadata: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.metadata, _a.validateMetadata),
            tokenUri: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.tokenUri),
            tokenHash: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.tokenHash),
            name: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.name),
            symbol: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.symbol),
            ownerOf: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.ownerOf, function(ownerOf) {
                return EvmAddress.create(ownerOf);
            }),
            blockNumberMinted: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.blockNumberMinted, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create),
            blockNumber: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.blockNumber, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create),
            lastMetadataSync: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.lastMetadataSync, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dateInputToDate"]),
            lastTokenUriSync: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.lastTokenUriSync, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dateInputToDate"]),
            amount: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.amount, function(value) {
                return +value;
            }),
            media: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.media, function(value) {
 ...
 */ var EvmNftCollection = function() {
    ...
    EvmNftCollection.parse = function(data) {
        return __assign(__assign({}, data), {
            tokenAddress: EvmAddress.create(data.tokenAddress),
            chain: EvmChain.create(data.chain),
            contractType: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.contractType)
 ...
 */ var EvmNftMetadata = function() {
    ...
    EvmNftMetadata.parse = function(data) {
        return __assign(__assign({}, data), {
            chain: EvmChain.create(data.chain),
            tokenAddress: EvmAddress.create(data.tokenAddress),
            syncedAt: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.syncedAt, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dateInputToDate"])
        });
    };
 ...
 */ var EvmNftTransfer = function() {
    ...
    EvmNftTransfer.parse = function(data) {
        return __assign(__assign({}, data), {
            chain: EvmChain.create(data.chain),
            amount: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.amount, function(amount) {
                return +amount;
            }),
            blockNumber: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.blockNumber),
            blockTimestamp: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dateInputToDate"])(data.blockTimestamp),
            transactionIndex: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.transactionIndex, function(index) {
                return +index;
            }),
            transactionType: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.transactionType),
            fromAddress: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.fromAddress, function(address) {
                return EvmAddress.create(address);
            }),
            toAddress: EvmAddress.create(data.toAddress),
            tokenAddress: EvmAddress.create(data.tokenAddress),
            value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.value, EvmNative.create),
            operator: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.operator, function(operator) {
 ...
 *
 * @category DataType
 */ var EvmTransactionLogDecoded = function(_super) {
 ...
 *
 * @category DataType
 */ var EvmTransactionVerbose = function(_super) {
...
var EvmTrade = function() {
    function EvmTrade(input) {
        ...
        this.blockNumber = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(input.blockNumber);
    ...
    EvmTrade.fromJSON = function(json) {
        var input = {
            ...
            blockNumber: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].fromJSON(json.block_number),
            blockHash: json.block_hash
        };
...
var EvmTradeCollection = function() {
...
var EvmSoldPriceLastSalePaymentToken = function() {
...
var EvmSoldPriceLastSale = function() {
...
var EvmSoldPriceLowestSalePaymentToken = function() {
...
var EvmSoldPriceLowestSale = function() {
...
var EvmSoldPriceHighestSalePaymentToken = function() {
...
var EvmSoldPriceHighestSale = function() {
...
var EvmSoldPriceAverageSale = function() {
...
var EvmNativeErc20Price = function() {
...
var EvmTokenPriceItem = function() {
...
var EvmGetMultipleTokenPricesDto = function() {
...
var EvmErc20TokenOwner = function() {
...
var EvmErc20TokenOwnerCollection = function() {
...
var EvmContractTokenDetails = function() {
...
var EvmContractSpenderDetails = function() {
...
var EvmCommonContractData = function() {
...
var EvmResolveContractInteractionResponse = function() {
...
var EvmNormalizedMetadataAttribute = function() {
...
var EvmNormalizedMetadata = function() {
...
var EvmWalletHistoryNftTransfer = function() {
...
var EvmWalletHistoryErc20Transfer = function() {
...
var EvmNativeTransfer = function() {
...
var EvmDecodedEventParamsItem = function() {
...
var EvmWalletHistoryTransaction = function() {
...
var EvmErc20TokenBalanceWithPrice = function() {
...
var EvmErc20TokenBalanceWithPriceResult = function() {
...
var EvmUnavailableChainNetWorth = function() {
...
var EvmNetWorthResult = function() {
...
var EvmEndpointWeights = function() {
...
var EvmUnstoppableDomain = function() {
...
var EvmErc20Metadata = function() {
    function EvmErc20Metadata(input) {
        ...
        this.blockNumber = input.blockNumber ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(input.blockNumber) : undefined;
    ...
    EvmErc20Metadata.fromJSON = function(json) {
        var input = {
            ...
            blockNumber: json.block_number ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].fromJSON(json.block_number) : undefined,
...
var EvmMarketDataERC20TokenItem = function() {
...
var EvmMarketDataERC20TokensByPriceMovers = function() {
...
var EvmMarketDataTopNFTCollectionByMarketCapItem = function() {
...
var EvmMarketDataHottestNFTCollectionByTradingVolumeItem = function() {
...
var EvmMarketDataTopCryptoCurrenciesByMarketCapItem = function() {
...
var EvmReviewContracts = function() {
...
var EvmContractsReviewItem = function() {
...
var EvmContractsReviewDto = function() {
...
var EvmDefiProtocolBalance = function() {
...
var EvmWalletDefiSummary = function() {
...
var EvmDefiTokenBalance = function() {
...
var EvmDefiPositionDetails = function() {
...
var EvmDefiProtocolPosition = function() {
...
var EvmGetDefiPositionsByProtocol = function() {
...
var EvmDefiPositionSummaryResponse = function() {
...
var EvmTransactionTimestamp = function() {
...
var EvmWalletActiveChain = function() {
...
var EvmWalletActiveChains = function() {
...
var EvmWalletStatTransactions = function() {
...
var EvmWalletStatNftTransfers = function() {
...
var EvmWalletStatTokenTransfers = function() {
...
var EvmNftCollectionStatOwners = function() {
...
var EvmNftCollectionStatTransfers = function() {
...
var EvmNftCollectionStat = function() {
...
var EvmNftTokenStatOwners = function() {
...
var EvmNftTokenStatTransfers = function() {
...
var EvmErc20TokenStatTransfers = function() {
...
var EvmErc20TokenStat = function() {
...
var EvmBlockTokenStatTransactions = function() {
...
var EvmBlockTokenStatNftTransfers = function() {
...
var EvmBlockTokenStat = function() {
...
var EvmGetWalletProfitabilitySummary = function() {
...
var EvmWalletProfitabilityTokenData = function() {
...
var EvmWalletProfitabilityResponse = function() {
...
var EvmTopProfitableWalletPerTokenResponse = function() {
...
var EvmWalletTopProfitableWalletPerTokenResponse = function() {
...
var CommonEvmUtilsConfigSetup = function() {
...
var CommonEvmUtils = function(_super) {
    ...
    CommonEvmUtils.create = function(core) {
        return new CommonEvmUtils(core !== null && core !== void 0 ? core : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CoreProvider"].getDefault());
    };
...
/** Get the native balance for a specific wallet address. */ var getNativeBalanceOperation = {
    method: 'GET',
...
function getRequestUrlParams$H(request, core) {
    return {
        ...
        to_block: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.toBlock, String),
...
/** Get the native balances for a set of specific addresses */ var getNativeBalancesForAddressesOperation = {
    method: 'GET',
...
/** Get the contents of a block given the block hash. */ var getBlockOperation = {
    method: 'GET',
    name: 'getBlock',
    id: 'getBlock',
    groupName: 'block',
...
function deserializeResponse$F(jsonResponse, request, core) {
    var _a;
    var data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCamelCase"])(jsonResponse);
    ...
    return EvmBlock.create(__assign(__assign({}, data), {
        chain: chain,
        transactions: ((_a = data.transactions) !== null && _a !== void 0 ? _a : []).map(function(transaction) {
            ...
            return EvmTransaction.create({
                ...
                logs: ((_a = transaction.logs) !== null && _a !== void 0 ? _a : []).map(function(jsonLog) {
                    var log = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCamelCase"])(jsonLog);
                ...
                internalTransactions: ((_b = transaction.internalTransactions) !== null && _b !== void 0 ? _b : []).map(function(jsonInternalTransaction) {
                    var internalTransaction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCamelCase"])(jsonInternalTransaction);
...
/** Get the closest block given the date. */ var getDateToBlockOperation = {
    method: 'GET',
    name: 'getDateToBlock',
    id: 'getDateToBlock',
    groupName: 'block',
...
/** Get the liquidity reserves for a given pair address. Only Uniswap V2 based exchanges supported at the moment. */ var getPairReservesOperation = {
    method: 'GET',
...
/** Get events for a contract ordered by block number in descending order. */ var getContractEventsOperation = {
    method: 'POST',
...
function getRequestUrlParams$B(request, core) {
    return {
        chain: EvmChainResolver.resolve(request.chain, core).apiHex,
        from_block: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.fromBlock, String),
        to_block: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.toBlock, String),
        from_date: request.fromDate ? new Date(request.fromDate).toISOString() : undefined,
        to_date: request.toDate ? new Date(request.toDate).toISOString() : undefined,
        topic: request.topic,
        offset: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.offset, String),
        limit: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.limit, String),
        address: EvmAddress.create(request.address).lowercase,
    ...
    return (_b = (_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []) === null || _b === void 0 ? void 0 : _b.map(function(event) {
        return EvmEvent.create({
            ...
            data: {
                ...
                value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(event.data.value, function(value) {
...
/** Get the logs for a contract. */ var getContractLogsOperation = {
    method: 'GET',
...
function deserializeResponse$A(jsonResponse, request, core) {
    ...
    return (_b = (_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []) === null || _b === void 0 ? void 0 : _b.map(function(log) {
        return EvmTransactionLog.create(__assign(__assign({}, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCamelCase"])(log)), {
            topics: [
                log.topic0,
                log.topic1,
                log.topic2,
...
/** Upload multiple files to IPFS and place them in a folder directory. */ var uploadFolderOperation = {
    method: 'POST',
    name: 'uploadFolder',
    id: 'uploadFolder',
    groupName: 'ipfs',
...
function getRequestUrlParams$y(request, core) {
    return {
        ...
        limit: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.limit, String),
        totalRanges: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.totalRanges, String),
        range: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.range, String),
        cursor: request.cursor,
...
function deserializeResponse$y(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function(data) {
        var chain = EvmChainResolver.resolve(request.chain, core);
        var nft = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCamelCase"])(data);
        return EvmNft.create(__assign(__assign({}, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCamelCase"])(nft)), {
            chain: chain,
            ...
            media: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(nft.media, function(media) {
                return EvmNftMedia.create(__assign({
                    chain: chain
                }, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCamelCase"])(media)));
            })
        }));
    });
}
...
function deserializeResponse$x(jsonResponse, request, core) {
    return (jsonResponse !== null && jsonResponse !== void 0 ? jsonResponse : []).map(function(data) {
        ...
        return EvmNft.create(__assign(__assign({}, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCamelCase"])(nft)), {
            ...
            lastMetadataSync: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dateInputToDate"])(nft.lastMetadataSync),
            lastTokenUriSync: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dateInputToDate"])(nft.lastTokenUriSync),
            media: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(nft.media, function(media) {
                return EvmNftMedia.create(__assign({
                    chain: chain
                }, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCamelCase"])(media)));
...
function deserializeResponse$w(jsonResponse, request, core) {
    return EvmNftMetadata.create(__assign(__assign({}, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCamelCase"])(jsonResponse)), {
        chain: EvmChainResolver.resolve(request.chain, core),
        ...
        contractType: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(jsonResponse.contract_type)
    }));
}
...
/** Get transfers of NFTs for a given contract and other parameters. */ var getNFTContractTransfersOperation = {
    method: 'GET',
...
function deserializeResponse$v(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function(transfer) {
        return EvmNftTransfer.create(__assign(__assign({}, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCamelCase"])(transfer)), {
            chain: EvmChainResolver.resolve(request.chain, core),
...
/** Get the lowest executed price for an NFT contract for the last x days (only trades paid in ETH). */ var getNFTLowestPriceOperation = {
    method: 'GET',
...
function getRequestUrlParams$u(request, core) {
    return {
        chain: EvmChainResolver.resolve(request.chain, core).apiHex,
        address: EvmAddress.create(request.address).lowercase,
        days: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.days, String),
...
function deserializeResponse$t(jsonResponse, request, core) {
    var chain = EvmChainResolver.resolve(request.chain, core);
    var nft = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCamelCase"])(jsonResponse);
    return EvmNft.create(__assign(__assign({}, nft), {
        chain: EvmChainResolver.resolve(request.chain, core),
        ownerOf: nft.ownerOf ? EvmAddress.create(nft.ownerOf) : undefined,
        lastMetadataSync: nft.lastMetadataSync ? new Date(nft.lastMetadataSync) : undefined,
        lastTokenUriSync: nft.lastTokenUriSync ? new Date(nft.lastTokenUriSync) : undefined,
...
/** Get trades of NFTs for a given contract and marketplace. */ var getNFTTradesOperation = {
    method: 'GET',
    name: 'getNFTTrades',
    id: 'getNFTTrades',
    groupName: 'nft',
...
/** Get transfers of NFTs given a block number or block hash. */ var getNFTTransfersByBlockOperation = {
    method: 'GET',
...
/** Get transfers of NFTs from a block number to a block number. */ var getNFTTransfersFromToBlockOperation = {
    method: 'GET',
...
/** Get transfers of an NFT given a contract address and token ID. */ var getNFTTransfersOperation = {
    method: 'GET',
...
/** Get NFT collections owned by a given wallet address. */ var getWalletNFTCollectionsOperation = {
    method: 'GET',
...
function deserializeResponse$m(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function(collection) {
        return EvmNftCollection.create(__assign(__assign({}, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCamelCase"])(collection)), {
            chain: EvmChainResolver.resolve(request.chain, core),
...
function deserializeRequest$l(jsonRequest) {
    return {
        ...
        format: jsonRequest.format,
        limit: jsonRequest.limit,
        tokenAddresses: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(jsonRequest.tokenAddresses, function(addresses) {
...
/** Get transfers of NFTs given the wallet and other parameters. */ var getWalletNFTTransfersOperation = {
    method: 'GET',
...
function getRequestUrlParams$k(request, core) {
    ...
    return {
        ...
        limit: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.limit, String),
        cursor: request.cursor,
        from_date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.fromDate, function(date) {
            return new Date(date).toISOString();
        }),
        to_date: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.toDate, function(date) {
            return new Date(date).toISOString();
        }),
        order: request.order,
...
function serializeRequest$k(request, core) {
    ...
    return {
        ...
        cursor: request.cursor,
        address: EvmAddress.create(request.address).checksum,
        fromDate: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.fromDate, function(date) {
            return new Date(date).toISOString();
        }),
        toDate: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.toDate, function(date) {
            return new Date(date).toISOString();
        }),
        order: request.order,
...
/** Initiates a sync of a previously non synced Contract. */ var syncNFTContractOperation = {
    method: 'PUT',
...
/** Resolve an ETH address and find the ENS name. */ var resolveAddressOperation = {
    method: 'GET',
    name: 'resolveAddress',
    id: 'resolveAddress',
    groupName: 'resolve',
...
function getRequestUrlParams$h(request) {
    return {
        address: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.address, function(address) {
            return EvmAddress.create(address).checksum;
        })
    };
}
...
function deserializeRequest$h(jsonRequest) {
    return {
        address: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(jsonRequest.address, function(address) {
            return EvmAddress.create(address);
        })
    };
}
/** Resolve an Unstoppable domain and get the address. */ var resolveDomainOperation = {
    method: 'GET',
    name: 'resolveDomain',
    id: 'resolveDomain',
    groupName: 'resolve',
...
/** Resolve a specific ENS domain to its address. */ var resolveENSDomainOperation = {
    method: 'GET',
...
/** Get the amount which the spender is allowed to withdraw on behalf of the owner. */ var getTokenAllowanceOperation = {
    method: 'GET',
...
function deserializeResponse$e(jsonResponse) {
    return {
        allowance: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(jsonResponse.allowance)
    };
}
function serializeRequest$e(request, core) {
    return {
...
/** Get metadata for a list of token symbols (name, symbol, decimals, logo). */ var getTokenMetadataBySymbolOperation = {
    method: 'GET',
...
function deserializeResponse$d(jsonResponse, request, core) {
    return (jsonResponse !== null && jsonResponse !== void 0 ? jsonResponse : []).map(function(token) {
        return {
            token: Erc20Token.create(__assign(__assign({}, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCamelCase"])(token)), {
...
/** Get the metadata for a given token contract address (name, symbol, decimals, logo). */ var getTokenMetadataOperation = {
    method: 'GET',
...
/** Get the token price denominated in the blockchains native token and USD. */ var getTokenPriceOperation = {
    method: 'GET',
    name: 'getTokenPrice',
    id: 'getTokenPrice',
    groupName: 'token',
...
function deserializeResponse$b(jsonResponse) {
    var _a, _b, _c;
    return __assign(__assign({}, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCamelCase"])(jsonResponse)), {
        nativePrice: ((_a = jsonResponse.nativePrice) === null || _a === void 0 ? void 0 : _a.value) ? EvmNative.create((_b = jsonResponse.nativePrice) === null || _b === void 0 ? void 0 : _b.value, (_c = jsonResponse.nativePrice) === null || _c === void 0 ? void 0 : _c.decimals) : null,
...
/** Get ERC20 token transactions from a contract ordered by block number in descending order. */ var getTokenTransfersOperation = {
    method: 'GET',
...
function deserializeResponse$a(jsonResponse, request, core) {
    var _a;
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function(transfer) {
        return Erc20Transaction.create(__assign(__assign({}, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCamelCase"])(transfer)), {
            chain: EvmChainResolver.resolve(request.chain, core),
            address: EvmAddress.create(transfer.address),
            toAddress: EvmAddress.create(transfer.to_address),
            fromAddress: EvmAddress.create(transfer.from_address),
            value: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(transfer.value),
            blockTimestamp: new Date(transfer.block_timestamp)
        }));
    });
}
...
/** Get token balances for a specific wallet address. */ var getWalletTokenBalancesOperation = {
    method: 'GET',
...
function getRequestUrlParams$9(request, core) {
    return {
        chain: EvmChainResolver.resolve(request.chain, core).apiHex,
        to_block: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.toBlock, String),
        token_addresses: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.tokenAddresses, function(addresses) {
            return addresses.map(function(address) {
                return EvmAddress.create(address).lowercase;
            });
        }),
...
function serializeRequest$9(request, core) {
    return {
        chain: EvmChainResolver.resolve(request.chain, core).apiHex,
        tokenAddresses: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.tokenAddresses, function(addresses) {
            return addresses.map(function(address) {
                return EvmAddress.create(address).checksum;
            });
        }),
...
/** Get ERC20 token transactions ordered by block number in descending order. */ var getWalletTokenTransfersOperation = {
    method: 'GET',
...
/** Get the contents of a transaction by the given transaction hash. */ var getTransactionOperation = {
    method: 'GET',
    name: 'getTransaction',
    id: 'getTransaction',
...
/** Get the contents of a transaction by the given transaction hash. */ var getTransactionVerboseOperation = {
    method: 'GET',
...
/** Get native transactions ordered by block number in descending order. */ var getWalletTransactionsOperation = {
    method: 'GET',
...
function deserializeResponse$5(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function(transfer) {
        ...
        return EvmTransaction.create({
            ...
            blockTimestamp: new Date(transfer.block_timestamp),
            gas: transfer.gas ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(transfer.gas) : null,
...
/** Get native transactions ordered by block number in descending order. */ var getWalletTransactionsVerboseOperation = {
    method: 'GET',
...
function deserializeResponse$4(jsonResponse, request, core) {
    ...
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function(transfer) {
        ...
        return EvmTransaction.create({
            ...
            blockNumber: +transfer.block_number,
            blockTimestamp: new Date(transfer.block_timestamp),
            gas: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(transfer.gas),
...
/** Get native transactions ordered by block number in descending order. */ var getInternalTransactionsOperation = {
    method: 'GET',
...
/** Run a given function of a contract ABI and retrieve readonly data. */ var runContractFunctionOperation = {
    method: 'POST',
...
/** Get the endpoint price list for rate limits and cost. */ var endpointWeightsOperation = {
    method: 'GET',
...
/** Get the current version of the Moralis Web3 API. */ var web3ApiVersionOperation = {
    method: 'GET',
    name: 'web3ApiVersion',
    id: 'web3ApiVersion',
    groupName: 'utils',
...
//# sourceMappingURL=node_modules_%40moralisweb3_common-evm-utils_lib_esm_index_b3f54d.js.map