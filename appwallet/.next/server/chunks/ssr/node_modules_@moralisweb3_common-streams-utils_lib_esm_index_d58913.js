...
"[project]/node_modules/@moralisweb3/common-streams-utils/lib/esm/index.js [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, z: __turbopack_require_stub__ } = __turbopack_context__;
{
__turbopack_esm__({
    "AptosStream": (()=>AptosStream),
    "EvmStream": (()=>EvmStream),
    "EvmStreamResult": (()=>EvmStreamResult),
    "StreamErc1155Approval": (()=>StreamErc1155Approval),
    "StreamErc20Approval": (()=>StreamErc20Approval),
    "StreamErc20Transfer": (()=>StreamErc20Transfer),
    "StreamErc721Approval": (()=>StreamErc721Approval),
    "StreamEvmInternalTransaction": (()=>StreamEvmInternalTransaction),
    "StreamEvmNftTokenApproval": (()=>StreamEvmNftTokenApproval),
    "StreamEvmNftTransfer": (()=>StreamEvmNftTransfer),
    "StreamEvmTransaction": (()=>StreamEvmTransaction),
    "StreamEvmTransactionLog": (()=>StreamEvmTransactionLog),
    "StreamTrigger": (()=>StreamTrigger),
    "StreamTriggerOutput": (()=>StreamTriggerOutput),
    ...
    "getLogsOperation": (()=>getLogsOperation),
 ...
 */ var AptosStream = function() {
     ...
     */ AptosStream.prototype.toJSON = function() {
        return __assign(__assign({}, this._data), {
            network: this.network.map(function(network) {
    ...
    AptosStream.parse = function(data) {
        return __assign(__assign({}, data), {
            network: data.network.map(function(network) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$aptos$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AptosNetwork"].create(network);
            })
        });
    };
    return AptosStream;
 ...
 */ var StreamTrigger = function() {
    ...
    StreamTrigger.parseSelectorOrAddress = function(input) {
        ...
        if (!(input instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"]) && StreamSelector.isSelectorString(input)) {
            result = StreamSelector.create(input);
        } else {
            result = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(input);
        }
        return result;
    };
     ...
     */ StreamTrigger.prototype.toJSON = function() {
        var _a = this._data, contractAddress = _a.contractAddress, callFrom = _a.callFrom, data = __rest(_a, [
            "contractAddress",
            "callFrom"
        ]);
        return __assign(__assign({}, data), {
            contractAddress: contractAddress.toJSON(),
            callFrom: callFrom === null || callFrom === void 0 ? void 0 : callFrom.toJSON()
        });
    };
    /**
     * @deprecated This method will be removed soon. To format the value, use one of the properties.
    ...
    StreamTrigger.parse = function(data) {
        var contractAddressInput = data.contractAddress, callFromInput = data.callFrom, input = __rest(data, [
            "contractAddress",
            "callFrom"
        ]);
        var contractAddress = StreamTrigger.parseSelectorOrAddress(contractAddressInput);
        var callFrom = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(callFromInput, function(value) {
            return StreamTrigger.parseSelectorOrAddress(value);
        });
 ...
 */ var EvmStream = function() {
     ...
     */ EvmStream.equals = function(valueA, valueB) {
        ...
        if (((_a = evmStreamA.triggers) === null || _a === void 0 ? void 0 : _a.length) !== ((_b = evmStreamB.triggers) === null || _b === void 0 ? void 0 : _b.length) || !StreamTrigger.arrayEquals(evmStreamA.triggers || [], evmStreamB.triggers || [])) {
            return false;
        }
        return true;
    };
     ...
     */ EvmStream.prototype.toJSON = function() {
        var _a = this._data, chains = _a.chains, triggers = _a.triggers, data = __rest(_a, [
            "chains",
            "triggers"
        ]);
    ...
    EvmStream.parse = function(data) {
        ...
        return __assign(__assign({}, data), {
            chains: data.chainIds.map(function(chainId) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmChain"].create(chainId);
            }),
            topic0: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.topic0),
            ...
            includeAllTxLogs: (_d = data.includeAllTxLogs) !== null && _d !== void 0 ? _d : false,
            includeNativeTxs: (_e = data.includeNativeTxs) !== null && _e !== void 0 ? _e : false,
            advancedOptions: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.advancedOptions),
            abi: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.abi),
            triggers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.triggers, function(triggers) {
                return triggers.map(function(trigger) {
                    return StreamTrigger.create(trigger);
                });
            }),
            getNativeBalances: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.getNativeBalances)
        });
    };
    return EvmStream;
}();
var EvmStreamResultFormatter = function() {
    function EvmStreamResultFormatter() {}
    EvmStreamResultFormatter.toJSON = function(data) {
        return __assign(__assign({}, data), {
            erc20Transfers: data.erc20Transfers.map(function(value) {
                return value.toJSON();
            }),
            ...
            logs: data.logs.map(function(value) {
                return value.toJSON();
            }),
            ...
            abi: data.abi,
            nativeBalances: data.nativeBalances.map(function(nativeBalance) {
 ...
 *
 * @category DataType
 */ var StreamTriggerOutput = function() {
 ...
 *
 * @category DataType
 */ var StreamErc1155Approval = function() {
    ...
    StreamErc1155Approval.equals = function(valueA, valueB) {
        ...
        if (((_a = evmNftApprovalA.triggers) === null || _a === void 0 ? void 0 : _a.length) !== ((_b = evmNftApprovalB.triggers) === null || _b === void 0 ? void 0 : _b.length) || !StreamTriggerOutput.arrayEquals(evmNftApprovalA.triggers || [], evmNftApprovalB.triggers || [])) {
            return false;
        }
        return true;
    };
    ...
    StreamErc1155Approval.parse = function(data) {
        var chain = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmChain"].create(data.chain);
        return __assign(__assign({}, data), {
            chain: chain,
            logIndex: +data.logIndex,
            account: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(data.account),
            operator: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(data.operator),
            contract: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(data.contract),
 ...
 *
 * @category DataTypexw
 */ var StreamErc20Approval = function() {
     ...
     */ StreamErc20Approval.equals = function(valueA, valueB) {
        ...
        if (((_a = erc20ApprovalA.triggers) === null || _a === void 0 ? void 0 : _a.length) !== ((_b = erc20ApprovalB.triggers) === null || _b === void 0 ? void 0 : _b.length) || !StreamTriggerOutput.arrayEquals(erc20ApprovalA.triggers || [], erc20ApprovalB.triggers || [])) {
            return false;
        }
        return true;
    };
     ...
     */ StreamErc20Approval.prototype.toJSON = function() {
        var _a = this._data, chain = _a.chain, owner = _a.owner, spender = _a.spender, contract = _a.contract, value = _a.value, triggers = _a.triggers, data = __rest(_a, [
            "chain",
            "owner",
            "spender",
            "contract",
    ...
    StreamErc20Approval.parse = function(data) {
        ...
        return __assign(__assign({}, data), {
            chain: chain,
            spender: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(data.spender),
            owner: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(data.owner),
            logIndex: +data.logIndex,
            contract: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(data.contract),
            ...
            valueWithDecimals: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.valueWithDecimals),
 ...
 *
 * @category DataType
 */ var StreamErc20Transfer = function() {
     ...
     */ StreamErc20Transfer.equals = function(valueA, valueB) {
        ...
        if (((_a = erc20TransferA.triggers) === null || _a === void 0 ? void 0 : _a.length) !== ((_b = erc20TransferB.triggers) === null || _b === void 0 ? void 0 : _b.length) || !StreamTriggerOutput.arrayEquals(erc20TransferA.triggers || [], erc20TransferB.triggers || [])) {
            return false;
        }
        return true;
    };
     ...
     */ StreamErc20Transfer.prototype.toJSON = function() {
        var _a = this._data, chain = _a.chain, from = _a.from, to = _a.to, contract = _a.contract, value = _a.value, triggers = _a.triggers, data = __rest(_a, [
            "chain",
            "from",
            "to",
            "contract",
    ...
    StreamErc20Transfer.parse = function(data) {
        ...
        return __assign(__assign({}, data), {
            chain: chain,
            from: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(data.from),
            to: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(data.to),
            logIndex: +data.logIndex,
            contract: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(data.contract),
            value: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(data.value),
            valueWithDecimals: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.valueWithDecimals),
 ...
 *
 * @category DataType
 */ var StreamErc721Approval = function() {
    ...
    StreamErc721Approval.parse = function(data) {
        ...
        return __assign(__assign({}, data), {
            ...
            contract: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(data.contract),
            tokenContractType: data.tokenContractType,
            approved: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(data.approved),
            triggers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.triggers, function(triggers) {
                return triggers.map(function(trigger) {
                    return StreamTriggerOutput.create(trigger);
                });
 ...
 *
 * @category DataType
 */ var StreamEvmInternalTransaction = function() {
     ...
     */ StreamEvmInternalTransaction.equals = function(valueA, valueB) {
        ...
        if (((_a = evmInternalTransactionA.triggers) === null || _a === void 0 ? void 0 : _a.length) !== ((_b = evmInternalTransactionB.triggers) === null || _b === void 0 ? void 0 : _b.length) || !StreamTriggerOutput.arrayEquals(evmInternalTransactionA.triggers || [], evmInternalTransactionB.triggers || [])) {
            return false;
        }
        return true;
    };
     ...
     */ StreamEvmInternalTransaction.prototype.toJSON = function() {
        ...
        return __assign(__assign({}, data), {
            chain: data.chain.toJSON(),
            from: (_a = data.from) === null || _a === void 0 ? void 0 : _a.toJSON(),
            to: (_b = data.to) === null || _b === void 0 ? void 0 : _b.toJSON(),
    ...
    StreamEvmInternalTransaction.parse = function(data) {
        return __assign(__assign({}, data), {
            chain: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmChain"].create(data.chain),
            from: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.from, function(value) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(value);
            }),
            to: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.to, function(value) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(value);
            }),
            value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.value, function(value) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(value);
            }),
            gas: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.gas, function(value) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create(value);
            }),
            triggers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.triggers, function(triggers) {
                return triggers.map(function(trigger) {
 ...
 *
 * @category DataType
 */ var StreamEvmNftTransfer = function() {
    ...
    StreamEvmNftTransfer.parse = function(data) {
        return __assign(__assign({}, data), {
            ...
            operator: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.operator, function(operator) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(operator);
            }),
    ...
    StreamEvmNftTransfer.equals = function(valueA, valueB) {
        ...
        if (((_a = transferA.triggers) === null || _a === void 0 ? void 0 : _a.length) !== ((_b = transferB.triggers) === null || _b === void 0 ? void 0 : _b.length) || !StreamTriggerOutput.arrayEquals(transferA.triggers || [], transferB.triggers || [])) {
            return false;
        }
        return true;
    };
     ...
     */ StreamEvmNftTransfer.prototype.toJSON = function() {
        ...
        return __assign(__assign({}, data), {
            ...
            to: data.to.toJSON(),
            contract: data.contract.toJSON(),
            operator: (_a = data.operator) === null || _a === void 0 ? void 0 : _a.toJSON(),
 ...
 *
 * @category DataType
 */ var StreamEvmTransaction = function() {
    ...
    StreamEvmTransaction.parse = function(data) {
        var signature = data.r != null && data.s != null && data.v != null ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmSignature"].create({
            r: data.r,
            s: data.s,
            v: data.v
        }) : undefined;
        return __assign(__assign({}, data), {
            ...
            gasPrice: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.gasPrice, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create),
            ...
            input: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.input),
            fromAddress: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(data.fromAddress),
            toAddress: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.toAddress, function(address) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(address);
            }),
            value: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.value, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create),
            type: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.type, function(type) {
                return +type;
            }),
            receiptCumulativeGasUsed: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.receiptCumulativeGasUsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create),
            receiptGasUsed: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.receiptGasUsed, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BigNumber"].create),
            receiptContractAddress: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.receiptContractAddress, function(address) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(address);
            }),
     ...
     */ StreamEvmTransaction.equals = function(valueA, valueB) {
        ...
        if (((_a = transactionA.triggers) === null || _a === void 0 ? void 0 : _a.length) !== ((_b = transactionB.triggers) === null || _b === void 0 ? void 0 : _b.length) || !StreamTriggerOutput.arrayEquals(transactionA.triggers || [], transactionB.triggers || [])) {
            return false;
        }
        return true;
    };
     ...
     */ StreamEvmTransaction.prototype.toJSON = function() {
        ...
        return __assign(__assign({}, data), {
            ...
            nonce: nonce === null || nonce === void 0 ? void 0 : nonce.toString(),
            fromAddress: fromAddress.toJSON(),
            toAddress: toAddress === null || toAddress === void 0 ? void 0 : toAddress.toJSON(),
            value: value === null || value === void 0 ? void 0 : value.toString(),
            receiptCumulativeGasUsed: receiptCumulativeGasUsed === null || receiptCumulativeGasUsed === void 0 ? void 0 : receiptCumulativeGasUsed.toString(),
            receiptGasUsed: receiptGasUsed === null || receiptGasUsed === void 0 ? void 0 : receiptGasUsed.toString(),
            receiptContractAddress: receiptContractAddress === null || receiptContractAddress === void 0 ? void 0 : receiptContractAddress.toJSON(),
            r: signature === null || signature === void 0 ? void 0 : signature.r,
            s: signature === null || signature === void 0 ? void 0 : signature.s,
            v: signature === null || signature === void 0 ? void 0 : signature.v,
            triggers: triggers === null || triggers === void 0 ? void 0 : triggers.map(function(trigger) {
                return trigger.format();
            })
        });
 ...
 *
 * @category DataType
 */ var StreamEvmTransactionLog = function() {
    ...
    StreamEvmTransactionLog.parse = function(data) {
        return __assign(__assign({}, data), {
            chain: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmChain"].create(data.chain),
            logIndex: +data.logIndex,
            address: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(data.address),
            topic0: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.topic0),
            topic1: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.topic1),
            topic2: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.topic2),
            topic3: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.topic3),
            triggers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(data.triggers, function(triggers) {
                return triggers.map(function(trigger) {
                    return StreamTriggerOutput.create(trigger);
                });
     ...
     */ StreamEvmTransactionLog.equals = function(valueA, valueB) {
        ...
        if (((_a = transactionLogA.triggers) === null || _a === void 0 ? void 0 : _a.length) !== ((_b = transactionLogB.triggers) === null || _b === void 0 ? void 0 : _b.length) || !StreamTriggerOutput.arrayEquals(transactionLogA.triggers || [], transactionLogB.triggers || [])) {
            return false;
        }
        return true;
    };
     ...
     */ StreamEvmTransactionLog.prototype.toJSON = function() {
        var _a = this._data, chain = _a.chain, address = _a.address, triggers = _a.triggers, data = __rest(_a, [
            "chain",
            "address",
            "triggers"
        ]);
 ...
 *
 * @category DataType
 */ var StreamNativeBalance = function() {
    ...
    StreamNativeBalance.parse = function(input) {
        return {
            address: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(input.address),
            balance: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmNative"].create(input.balance, 'wei')
        };
    };
 ...
 *
 * @category DataType
 */ var StreamEvmNftTokenApproval = function() {
    function StreamEvmNftTokenApproval(data) {
        this.data = data;
    }
    StreamEvmNftTokenApproval.create = function(data) {
        var chain = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmChain"].create(data.chain);
        return new StreamEvmNftTokenApproval(__assign(__assign({}, data), {
            chain: chain
        }));
    };
...
var EvmStreamResultParser = function() {
    ...
    EvmStreamResultParser.parseChainId = function(value) {
        ...
        return value === '' ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmChain"].ETHEREUM : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmChain"].create(value);
    };
    EvmStreamResultParser.parseErc20Transfers = function(value, chain) {
        return value.map(function(transfer) {
            return StreamErc20Transfer.create(__assign({
                chain: chain
            }, transfer));
        });
    };
    EvmStreamResultParser.parseErc20Approvals = function(value, chain) {
        return value.map(function(approval) {
            return StreamErc20Approval.create(__assign({
                chain: chain
            }, approval));
        });
    };
    EvmStreamResultParser.parseNftTransfers = function(value, chain) {
        return value.map(function(transfer) {
            return StreamEvmNftTransfer.create(__assign({
                chain: chain
            }, transfer));
        });
    };
    EvmStreamResultParser.parseNftApprovals = function(value, chain) {
        return {
            ERC721: value.ERC721.map(function(approval) {
                return StreamErc721Approval.create(__assign({
                    chain: chain
                }, approval));
            }),
            ERC1155: value.ERC1155.map(function(approval) {
                return StreamErc1155Approval.create(__assign({
                    chain: chain
                }, approval));
            })
        };
    ...
    EvmStreamResultParser.parseNftTokenApprovals = function(values, chain) {
        return values.map(function(value) {
            return StreamEvmNftTokenApproval.create(__assign({
                chain: chain
            }, value));
        });
    };
    EvmStreamResultParser.parseBlock = function(value, chain) {
        if (value.number === '') {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmSimpleBlock"].create({
                chain: chain,
                number: 0,
                hash: '',
                timestamp: '0'
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmSimpleBlock"].create(__assign({
            chain: chain
        }, value));
    };
    EvmStreamResultParser.parseLogs = function(value, chain) {
        return value.map(function(log) {
            return StreamEvmTransactionLog.create(__assign({
                chain: chain
            }, log));
        });
    };
    EvmStreamResultParser.parseTransactions = function(value, chain) {
        return value.map(function(transaction) {
            return StreamEvmTransaction.create(__assign({
                chain: chain
            }, transaction));
        });
    };
    EvmStreamResultParser.parseInternalTransactions = function(value, chain) {
        return value.map(function(transaction) {
            return StreamEvmInternalTransaction.create(__assign({
                chain: chain
            }, transaction));
        });
    };
 ...
 */ var EvmStreamResult = function() {
    ...
    Object.defineProperty(EvmStreamResult.prototype, "abiInterface", {
        get: function() {
            ...
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ethersproject$2f$abi$2f$lib$2e$esm$2f$interface$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["Interface"](this.abi);
        },
        enumerable: false,
        configurable: true
    });
    ...
    EvmStreamResult.parse = function(data) {
...
function getRequestBody$d(request) {
    return {
        address: Array.isArray(request.address) ? request.address.map(function(a) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$aptos$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AptosAddress"].create(a).address;
        }) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$aptos$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AptosAddress"].create(request.address).address
    };
}
function deserializeResponse$o(jsonResponse) {
    ...
    return __assign(__assign({}, data), {
        address: data.address ? typeof data.address === 'string' ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$aptos$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AptosAddress"].create(data.address) : data.address.map(function(address) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$aptos$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AptosAddress"].create(address);
        }) : undefined
    });
}
...
function deserializeRequest$o(jsonRequest) {
    return {
        ...
        address: Array.isArray(jsonRequest.address) ? jsonRequest.address.map(function(a) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$aptos$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AptosAddress"].create(a);
        }) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$aptos$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AptosAddress"].create(jsonRequest.address)
    };
}
...
function deserializeResponse$n(jsonResponse) {
    var _a;
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function(stream) {
...
function serializeRequest$l(request) {
    return {
        ...
        includePayload: request.includePayload,
        network: request.network.map(function(network) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$aptos$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AptosNetwork"].create(network).network;
        }),
        events: request.events,
        functions: request.functions,
        tag: request.tag,
...
function getRequestBody$b(request) {
    return {
        address: Array.isArray(request.address) ? request.address.map(function(address) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$aptos$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AptosAddress"].create(address).address;
        }) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$aptos$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AptosAddress"].create(request.address).address
    };
}
...
function deserializeResponse$i(jsonResponse) {
    var _a;
    return {
        result: ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function(address) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$aptos$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AptosAddress"].create(address.address);
        }),
...
function getRequestBody$7(request) {
    return {
        address: Array.isArray(request.address) ? request.address.map(function(a) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(a).checksum;
        }) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(request.address).checksum
    };
}
function deserializeResponse$f(jsonResponse) {
    var data = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toCamelCase"])(jsonResponse);
    return __assign(__assign({}, data), {
        address: data.address ? typeof data.address === 'string' ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(data.address) : data.address.map(function(address) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(address);
        }) : undefined
    });
}
...
function deserializeRequest$f(jsonRequest) {
    return {
        id: jsonRequest.id,
        address: Array.isArray(jsonRequest.address) ? jsonRequest.address.map(function(a) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(a);
        }) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(jsonRequest.address)
    };
}
...
function getRequestBody$6(request) {
    ...
    return {
        ...
        chainIds: request.chains.map(function(chain) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmChain"].create(chain).apiHex;
        }),
        abi: request.abi,
        advancedOptions: request.advancedOptions,
        demo: request.demo,
        triggers: (_a = request.triggers) === null || _a === void 0 ? void 0 : _a.map(function(trigger) {
...
function deserializeRequest$c(jsonRequest) {
    ...
    return {
        ...
        demo: jsonRequest.demo,
        triggers: (_a = jsonRequest.triggers) === null || _a === void 0 ? void 0 : _a.map(function(trigger) {
            return StreamTrigger.create(trigger);
        })
    };
}
...
function getRequestBody$5(request) {
    return {
        address: Array.isArray(request.address) ? request.address.map(function(address) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(address).lowercase;
        }) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(request.address).lowercase
    };
}
...
function deserializeResponse$9(jsonResponse) {
    var _a;
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function(stream) {
        return __assign(__assign({}, stream), {
            address: stream.address ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmAddress"].create(stream.address) : undefined
        });
    });
}
...
function getRequestBody$3(request) {
    ...
    return {
        ...
        includeAllTxLogs: request.includeAllTxLogs,
        getNativeBalances: request.getNativeBalances,
        chainIds: (_a = request.chains) === null || _a === void 0 ? void 0 : _a.map(function(chain) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmChain"].create(chain).apiHex;
        }),
        abi: request.abi,
        advancedOptions: request.advancedOptions,
...
function deserializeRequest$8(jsonRequest) {
    ...
    return {
        ...
        includeInternalTxs: jsonRequest.includeInternalTxs,
        includeAllTxLogs: jsonRequest.includeAllTxLogs,
        chains: (_a = jsonRequest.chainIds) === null || _a === void 0 ? void 0 : _a.map(function(chainId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmChain"].create(chainId);
        }),
        abi: jsonRequest.abi,
        advancedOptions: jsonRequest.advancedOptions,
...
function getRequestUrlParams$6(request) {
    return {
        excludePayload: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.excludePayload, String),
        limit: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$core$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["maybe"])(request.limit, String),
        cursor: request.cursor
    };
}
...
function deserializeResponse$4(jsonResponse) {
    var _a;
    return ((_a = jsonResponse.result) !== null && _a !== void 0 ? _a : []).map(function(result) {
        return __assign(__assign({}, result), {
            chain: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$moralisweb3$2f$common$2d$evm$2d$utils$2f$lib$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EvmChain"].create(result.chain)
        });
    });
}
...
//# sourceMappingURL=node_modules_%40moralisweb3_common-streams-utils_lib_esm_index_d58913.js.map