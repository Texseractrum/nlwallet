            ...
            const typingInterval = setInterval({
                "Home.useEffect.typingInterval": ()=>{
                    if (charIndex < prompts[promptIndex].length) {
                        setCurrentPrompt({
                            "Home.useEffect.typingInterval": (prev)=>prev + prompts[promptIndex][charIndex]
                        }["Home.useEffect.typingInterval"]);
                        setCharIndex({
                            "Home.useEffect.typingInterval": (prev)=>prev + 1
                        }["Home.useEffect.typingInterval"]);
                    } else {
                        ...
                        setTimeout({
                            "Home.useEffect.typingInterval": ()=>{
                                ...
                                setCharIndex(0);
                                setPromptIndex({
                                    "Home.useEffect.typingInterval": (prev)=>(prev + 1) % prompts.length
                                }["Home.useEffect.typingInterval"]);
                            }
                        }["Home.useEffect.typingInterval"], 2000); // Wait for 2 seconds before starting the next prompt
                    }
                }
            }["Home.useEffect.typingInterval"], 100); // Adjust typing speed here
            return ({
...
_s(Home, "mvvSpLEwwmW6MeFmfiMMpzSI7bU=", false, function() {
    return [
